...
- [x] **PREP-01**: Enricher prompt restricts `can_be_done_ahead=true` to steps requiring extended lead time — brining, marinating (4+ hours), stock-making, dough proofing, curing, setting gelatin, fermenting — not quick tasks like herb rubs, chopping, or mixing
