...
export function RecipePDF({ session, results }: RecipePDFProps) {
  ...
  const dayOf = schedule.timeline.filter((e) => !e.is_prep_ahead);
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={s.page}>
        ...
        <TimelineSection label="Prep Ahead" entries={prepAhead} />
        <TimelineSection label="Day-Of Timeline" entries={dayOf} />
